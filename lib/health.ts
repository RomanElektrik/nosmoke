...
export const MILESTONES: Milestone[] = [
  { id: 'm20', at: 20 * MIN,   icon: 'heartPulse',  color: '#FF453A', titleKey: 'health.m20.t', bodyKey: 'health.m20.b', source: 'CDC' },
  { id: 'h8',  at: 8 * HOUR,   icon: 'o2',   color: '#5AC8FA', titleKey: 'health.h8.t',  bodyKey: 'health.h8.b',  source: 'NHS' },
  { id: 'd1',  at: 1 * DAY,    icon: 'pulse',  color: '#FF453A', titleKey: 'health.d1.t',  bodyKey: 'health.d1.b',  source: 'AHA' },
  { id: 'd2',  at: 2 * DAY,    icon: 'taste',color: '#FF9F0A', titleKey: 'health.d2.t',  bodyKey: 'health.d2.b',  source: 'NHS' },
  ...
  { id: 'm9',  at: 9 * MONTH,  icon: 'lungs',   color: '#5AC8FA', titleKey: 'health.m9.t',  bodyKey: 'health.m9.b',  source: 'NHS' },
