...
export const TECHNIQUES: Technique[] = [
  { id: 'cyclic_sigh', evidence: 'A', durationMin: 5, tags: ['craving','physical','daily'], icon: 'lungs', color: '#0A84FF',
    titleKey: 'tech.cyclic.t',  summaryKey: 'tech.cyclic.s',  bodyKey: 'tech.cyclic.b',  practice: 'cyclic_sigh' },
  { id: 'box_breath',  evidence: 'B', durationMin: 1, tags: ['craving','physical'], icon: 'boxBreath', color: '#5AC8FA',
    titleKey: 'tech.box.t',     summaryKey: 'tech.box.s',     bodyKey: 'tech.box.b',     practice: 'box_breath' },
  { id: 'pharma',      evidence: 'A', durationMin: 5, tags: ['physical'],           icon: 'pill',     color: '#34C759',
    titleKey: 'tech.pharma.t',  summaryKey: 'tech.pharma.s',  bodyKey: 'tech.pharma.b',  practice: 'pharma' },
  { id: 'urge_surf',   evidence: 'A', durationMin: 4, tags: ['craving'],            icon: 'waves',    color: '#0A84FF',
    titleKey: 'tech.surf.t',    summaryKey: 'tech.surf.s',    bodyKey: 'tech.surf.b',    practice: 'urge_surf' },
  { id: 'halt',        evidence: 'B', durationMin: 1, tags: ['craving','mindset'],  icon: 'gauge',    color: '#FF9F0A',
  ...
  { id: 'grounding',   evidence: 'B', durationMin: 2, tags: ['craving','physical'], icon: 'compass',  color: '#BF5AF2',
  ...
  { id: 'mindfulness', evidence: 'A', durationMin: 10, tags: ['craving','daily'],   icon: 'meditate', color: '#FF9500',
