...
export const PRACTICE_SCRIPTS: Record<string, string[]> = {
  calm_now: [
    'Привет. Накрыло сильно — это нормально. Сейчас переждём вместе. Дыши за моим счётом, я веду.',
    'Вдыхай через нос.. один.. два.. три.. четыре. Задержи.. один.. два.. три.. четыре.. пять.. шесть.. семь. И медленно выдыхай ртом.. один.. два.. три.. четыре.. пять.. шесть.. семь.. восемь.',
    'Ещё раз. Вдох.. один.. два.. три.. четыре. Держим.. один.. два.. три.. четыре.. пять.. шесть.. семь. Выдох.. один.. два.. три.. четыре.. пять.. шесть.. семь.. восемь.',
    'Третий. Вдох.. один.. два.. три.. четыре. Держим.. один.. два.. три.. четыре.. пять.. шесть.. семь. Выдох.. один.. два.. три.. четыре.. пять.. шесть.. семь.. восемь.',
    'Последний. Вдох.. один.. два.. три.. четыре. Держим.. один.. два.. три.. четыре.. пять.. шесть.. семь. Длинный выдох.. один.. два.. три.. четыре.. пять.. шесть.. семь.. восемь.',
    'Чувствуешь? Волна спала. Ты оказался сильнее неё. Молодец.',
  ],
  surf: [
    'Не борись с тягой. Давай просто посмотрим на неё вместе, со стороны.',
    'Где ты её чувствуешь в теле? В груди, в горле, в руках? Найди это место.',
    'Это всего лишь ощущение. Не приказ — ощущение. Понаблюдай, как оно себя ведёт.',
    'Сейчас оно нарастает, как волна в море… поднимается… выше… доходит до самого гребня.',
    ...
    'Вот так. Она почти прошла.',
    'Запомни это: каждая волна, которую ты переждал, делает следующую слабее. Ты прямо сейчас учишь свой мозг — тягу можно пережить, и ничего страшного не случается.',
  ],
  release: [
    ...
    'И лицо. Разожми челюсть. Разгладь лоб, и место между бровями.',
    'Всё тело спокойно и тяжело. Просто побудь в этом покое.',
    'Когда будешь готов — не торопясь, медленно открой глаза. Ты дал себе пару спокойных минут. Это и есть забота о себе.',
  ],
  grounding: [
    ...
    'Теперь прислушайся — найди четыре разных звука вокруг тебя.',
    ...
    'И один вкус у тебя во рту.',
    'Сделай спокойный вдох.',
    'Ты здесь и сейчас. Тяга — это просто волна, а ты крепко стоишь на земле.',
  ],
  sleep: [
    'День закончен. Сигарета тебе не нужна — нужен покой. Я помогу уснуть. Дыши за моим счётом.',
    'Вдох через нос.. один.. два.. три.. четыре. И долгий выдох.. один.. два.. три.. четыре.. пять.. шесть.',
    'Ещё. Вдох.. один.. два.. три.. четыре. Выдох.. один.. два.. три.. четыре.. пять.. шесть.',
    'С каждым выдохом тело тяжелеет и опускается в кровать. Вдох.. один.. два.. три.. четыре. Выдох.. один.. два.. три.. четыре.. пять.. шесть.',
    'Ещё разок. Вдох.. один.. два.. три.. четыре. Выдох.. один.. два.. три.. четыре.. пять.. шесть.',
    'Отпусти мысли о завтра. Сейчас только дыхание и тишина. Дыши спокойно, я рядом.',
    'Ты — тот, кто не курит. Сегодня ты засыпаешь свободным. Спокойной ночи.',
  ],
  you_got_this: [
