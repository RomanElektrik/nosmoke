...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'd100', category: 'time', icon: 'hundred', color: '#FF9F0A',
  ...
  { id: 'h8h',  category: 'health', icon: 'o2', color: '#5AC8FA',
  ...
  { id: 'h48h', category: 'health', icon: 'taste', color: '#FF9F0A',
  ...
  { id: 'c500',  category: 'cigs', icon: 'noSmoke', color: '#FF9500',
  ...
  { id: 'streak30', category: 'engagement', icon: 'fire', color: '#FF453A',
