...
- EXPLICIT-REQUEST OVERRIDE: if the user directly ASKS for help, a tool, or "how do I cope with the craving" — answer with EXACTLY ONE concrete suggestion IMMEDIATELY, with its [[marker]] button. ONE, not a menu of options. Refusing to suggest anything when asked is as bad as spamming techniques. Best first answers for an acute urge: the SOS wave [[sos]]${locale === 'ru' ? ' or a guided audio practice [[audio]]' : ''} — NOT breathing.
